...
public class CharacterAssetManager : MonoBehaviour
{
    ...
    private Dictionary<int, Dictionary<ChataterType, CharatorData>> assetMapping;
    ...
    {
        assetMapping = new Dictionary<int, Dictionary<ChataterType, CharatorData>>();
        foreach (var mapping in levelCharacterMappings)
        {
            ...
            Dictionary<ChataterType, CharatorData> typeDict =
                new Dictionary<ChataterType, CharatorData>();
